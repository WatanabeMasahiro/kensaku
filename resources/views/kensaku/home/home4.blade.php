...
<div class="content container-fluid">
  ...
  @include('kensaku.includes.homeContents.searchBox', ['num' => '4'])
  ...
  <nav class="d-sm-none" aria-label="ページネーション">
    <ul class="paginationBar pagination pagination-lg justify-content-center">
      <li class="page-item"><a class="paginate3 page-link" href="/kensaku/home3">&laquo;</a></li>
      ...
      <li class="page-item active"><a class="paginate4 page-link" href="/kensaku/home4">4</a></li>
      <li class="page-item"><a class="paginate5 page-link" href="/kensaku/home5">5</a></li>
      <li class="page-item"><a class="paginate5 page-link" href="/kensaku/home5">&raquo;</a></li>
    </ul>
  </nav>
