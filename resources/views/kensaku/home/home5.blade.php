...
<div class="content container-fluid">
  ...
  @include('kensaku.includes.homeContents.searchBox', ['num' => '5'])
  ...
  <nav class="d-sm-none" aria-label="ページネーション">
    <ul class="paginationBar pagination pagination-lg justify-content-center">
      <li class="page-item"><a class="paginate4 page-link" href="/kensaku/home4">&laquo;</a></li>
      ...
      <li class="page-item active"><a class="paginate5 page-link" href="/kensaku/home5">5</a></li>
