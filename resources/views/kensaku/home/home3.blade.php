...
<div class="content container-fluid">
  ...
  @include('kensaku.includes.homeContents.searchBox', ['num' => '3'])
  ...
  <nav class="d-sm-none" aria-label="ページネーション">
    <ul class="paginationBar pagination pagination-lg justify-content-center">
      <li class="page-item"><a class="paginate2 page-link" href="/kensaku/home2">&laquo;</a></li>
      ...
      <li class="page-item active"><a class="paginate3 page-link" href="/kensaku/home3">3</a></li>
      ...
      <li class="page-item"><a class="paginate4 page-link" href="/kensaku/home4">&raquo;</a></li>
    </ul>
  </nav>
